    ...
    <div className="py-8">
      ...
      <Panel className="w-full p-8 flex flex-col gap-6">
        <div className="flex flex-col gap-3">
          ...
          <p>
            Cubic is a generative art project. Data such as ownership history
            and transaction history are used in different ways to generate
            unique canvases in a variety of styles.
          </p>
          <p>
        ...
        <div className="flex flex-col gap-3">
          ...
          <p>
            ...
            that <strong>you are willing to sell for</strong>. This artwork is
            always for sale; anyone will be able to purchase it at that price at
            any time.
          </p>
          <p>
            You will be charged a tax based on this price
            {data &&
              ` (currently ${formatPercent(
                Number(data.stats.annualTaxRate) / 1e8
              )} annual)`}
            , which is deducted automatically from your CUBE balance. The
            Harberger Tax system incentivizes owners to properly assess the
            value of their assets.
          </p>
          <p>
            If you don't have enough CUBE to pay tax, your artwork will be{" "}
        ...
        <div className="flex flex-col gap-3">
          ...
          <p>A 1% transaction fee is charged on all purchases.</p>
          <p>
            Collected fees and taxes are currently kept in the cubic treasury.
            Revenue will be shared with artists at some point in the future.
          </p>
        </div>
      </Panel>
    </div>
